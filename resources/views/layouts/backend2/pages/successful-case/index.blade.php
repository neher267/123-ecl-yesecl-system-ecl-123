                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{asset('public/'.$result->image1)}}" style="height: 50px; box-shadow: 2px 4px 5px darkgrey; margin: 3px;">
                            </td>
                            <td>
                                <img src="{{asset('public/'.$result->image2)}}" style="height: 50px; box-shadow: 2px 4px 5px darkgrey; margin: 3px;">
                            </td>
                            <td>
                                <img src="{{asset('public/'.$result->image3)}}" style="height: 50px; box-shadow: 2px 4px 5px darkgrey; margin: 3px;">
                            </td>
                            <td>
