                ...
                <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                    <div class="profile_img">
                        <div id="crop-avatar">
                            <!-- Current avatar -->
                            @if(empty($user->image))
                            <img style="height: 150px; width: 145px" class="img-responsive avatar-view" src="{{asset('public/'.'images/user.png')}}" alt="Avatar" title="Change the avatar">
                            @else
                            <img style="height: 150px; width: 145px" class="img-responsive avatar-view" src="{{asset('public/'.$user->image)}}" alt="Avatar" title="Change the avatar">
                            @endif 
                        </div>
                    </div>
                    <h3>{{ $user->name }}</h3>
