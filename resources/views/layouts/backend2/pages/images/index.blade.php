                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{++$i}}</td>
                            <td>
                                <img src="{{asset('public/'.$result->src)}}" style="height: 50px; width: 120px; box-shadow: 2px 4px 5px darkgrey; margin: 3px;">
                            </td>
                            <td>{{$result->name}}</td>                            
                            ...
                            <td>
                            	<a href="{{asset('public/'.$result->src)}}" class="btn btn-primary btn-xs" target="_blank"><i class="fa fa-folder"></i> View </a>
