                        ...
                        <div class="row single">
                            <div class="det">
                                <div class="single_left">
                                    ...
                                    <div class="col-md-6">
                                        <h3 class="details-heading" style="color: #ff6600; margin:0px;">{{$product->name}}</h3>
                                        <div class="price">
                                            <span class="details-title">Brand: </span>
                                            <a href="{{$product->brand()->first()->url}}" target="_blank">

                                                <img src="{{asset('public/'.$product->brand()->first()->src)}}" style="height: 60px; border-radius: 4px;">
                                            </a>
                                            <br>
                                            ...
                                            <div style="margin: 15px 0px; text-align: justify;">
                                                <span class="details-title" style="font-size: 15px;">Features:</span><br>
                                        ...
                                        @if($product->document)
                                        <a href="{{asset('public/'.$product->document)}}" class="btn btn-sm btn-info">Product Document</a>
                                        @endif
                                        <!-- <div class="btn_form">
                                ...
                                <div class="col-md-offset-2 col-md-8 single-bottom1">
