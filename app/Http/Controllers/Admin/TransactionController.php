...
class TransactionController extends Controller
{
    ...
    public function index(User $user)
    {
        ...
        return view('layouts.backend2.pages.transactions.index', compact('user','page_title', 'results'));
    }
    ...
    public function create(User $user)
    {
        ...
        return view('layouts.backend2.pages.transactions.create', compact('course','user','page_title', 'due'));
    }
