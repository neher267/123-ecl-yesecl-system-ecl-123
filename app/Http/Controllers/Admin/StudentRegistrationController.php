...
class StudentRegistrationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layouts.backend2.pages.students.index', compact('results', 'page_title', 'name'));
    }
    ...
    public function create_student(StudentInfo $student_info)
    {
    	...
    	return view('layouts.backend2.pages.students.create', compact('student_info', 'page_title', 'name'));
    }
