...
<div class="container div-height">
	<div style="padding-bottom: 10px">
		<h1 class="text-center" style="margin-bottom: 25px;">Plan Your Career Now</h1>
		<p>
	...
	<div class="row" style="margin-top: 20px">
	    <div class="col-sm-6">
	        <div class="botm">
	            ...
	            <p>Being the Market leaders with a vast experience of 3 decade, LIVEWIRE courses are designed as per the industry needs.</p>
	        </div>
	    </div>
	    <div class="col-sm-6">
	        <div class="botm">
	            ...
	            <p>The Product Portfolio is filled with technologies that are current and trending. We choose courses that has a high level of scope in the Job market.</p>
	        </div>
	    </div>
	</div>
	...
	<div class="row">
	    <div class="col-sm-6">
	        <div class="botm">
	            ...
	            <p>Happy customers builds our strong Alumni network, where they share their industry experience for the next generation.</p>
	        </div>
	    </div>
	    <div class="col-sm-6">
	        <div class="botm">
	            ...
	            <p>Certified for the Quality Training and Competence of learning service providers to all relevant stakeholders.</p>
	        </div>
	    </div>
	</div>
