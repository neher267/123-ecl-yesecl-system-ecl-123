        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">                
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-angellist"></i> Training <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{route('courses.index')}}">Courses</a></li>
                            <li><a href="{{route('students.index')}}">Students</a></li>                            
                            <li><a href="{{route('categories.index')}}">Training Categories</a></li>
                            <li><a href="{{route('student-infos.index')}}">Student Infos</a></li>                           
                        </ul>
                    </li> 
                    <li><a href="{{route('inquiryes.index')}}"><i class="fa fa-angellist"></i> Inqueryes</a></li> 
                    @if(Auth::user()->role == 1)
