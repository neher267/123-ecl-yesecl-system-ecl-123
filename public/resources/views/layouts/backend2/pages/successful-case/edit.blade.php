        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="{{route('project-types.update', $result)}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="s_description">Short Description <span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="s_description" id="s_description" required="required" class="form-control col-md-7 col-xs-12">{{$result->s_description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <img src="{{asset('public/'.$result->image)}}" style="margin: 15px 0px; width: 100%">
