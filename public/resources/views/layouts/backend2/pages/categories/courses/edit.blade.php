            ...
            <div class="x_content">
                ...
                <form action="{{route($name.'.update', $result)}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <img src="{{asset('public/'.$result->thumnail)}}" style="margin: 15px 0px; height: 200px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <img src="{{asset('public/'.$result->background)}}" style="margin: 15px 0px; height: 200px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <img src="{{asset('public/'.$result->referance)}}" style="margin: 15px 0px; height: 200px;">
