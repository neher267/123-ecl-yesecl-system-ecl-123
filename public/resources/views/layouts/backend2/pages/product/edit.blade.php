            ...
            <div class="x_content">
                ...
                <form action="{{route('products.update', $result)}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <img src="{{asset('public/'.$result->image)}}" style="margin: 15px 0px; height: 200px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            ...
                            <img src="{{asset('public/'.$result->image2)}}" style="margin: 15px 0px; height: 200px; width: 350px">
                            @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            ...
                            <img src="{{asset('public/'.$result->image3)}}" style="margin: 15px 0px; height: 200px;">
                            @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            ...
                            <img src="{{asset('public/'.$result->image4)}}" style="margin: 15px 0px; height: 200px;">
                            @endif
