...
<head>
    <link rel="stylesheet" href="{{asset('public/css/invoice/generator.min.css')}}" media="all">
    <meta charset="utf-8">
    <title>Invoice</title>

    <link rel="stylesheet" href="{{asset('public/css/invoice/template.css')}}">
</head>
...
<body>
    <div id="container">
        ...
        <section id="memo">
            <div class="logo">
                <img src="{{asset('public/img/logo.png')}}" style="display: block;">
            </div>
